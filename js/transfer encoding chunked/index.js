...
http
  .createServer(function (request, response) {
    ...
    setTimeout(function () {
      html =
        "<h5>This is a chunked response after 5 seconds. The server should not close the stream before all chunks are sent to a client.</h5>";
    ...
    setTimeout(function () {
      html =
        "<h5>This is a chunked response after 2 seconds. Should be displayed before 5-second chunk arrives.</h5>";
